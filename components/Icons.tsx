...
// Using React.SVGProps<SVGSVGElement> for type safety on standard SVG attributes like className
...
export const ChefHatIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5c0-1.105.895-2 2-2s2 .895 2 2V21M3 13.5v7.5M3 13.5C3 9.358 6.358 6 10.5 6h3c4.142 0 7.5 3.358 7.5 7.5v7.5M3 13.5h18M6 6.75C6 5.231 7.231 4 8.75 4h6.5C16.769 4 18 5.231 18 6.75V11.25c0 .966-.784 1.75-1.75 1.75h-9.5A1.75 1.75 0 015 11.25V6.75h1z" />
    </svg>
);
...
export const TimerIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m8.485-15.485l-.707.707M4.222 19.778l-.707.707M21 12h-1M4 12H3" />
    </svg>
);
